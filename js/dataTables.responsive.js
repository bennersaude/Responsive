...
Responsive.prototype = {
	...
	_resize: function ()
	{
        ...
        // Custom code to control when the first column will be displayed
		var expandTds = $(".responsive-expand");

		for (var td in expandTds.toArray()) {
		    if (expandTds.hasOwnProperty(td)) {
		        if (collapsedClass) {
		            $(expandTds[td]).removeClass("hide");
		        } else {
		            $(expandTds[td]).addClass("hide");
		        }
		    }
		}
